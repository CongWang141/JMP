...
\vspace{0.5cm}
    ...
    A GitHub \textcolor{blue}{\href{https://github.com/CongWang141/JMP}{repository}} contains not only the package to apply this new method, but a Jupyter Notebook includes a step-by-step demonstration of the estimation.
